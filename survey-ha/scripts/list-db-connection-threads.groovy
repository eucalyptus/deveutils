...
["eucalyptus_cloud","eucalyptus_auth"].collect{ ctx ->
  ConnectionPoolManager.getInstance().getConnectionPool(ctx).getProxyConnections( ).findAll{ it.isActive() || it.isClosed() }.collect{ ProxyConnection p ->
